"""Temp solution for training on TPUs. Tensorflow trainer class."""
...
from transformers.integrations import is_comet_available, is_wandb_available
from transformers.modeling_tf_utils import TFPreTrainedModel
from transformers.optimization_tf import GradientAccumulator, create_optimizer
from transformers.trainer_utils import PREFIX_CHECKPOINT_DIR, EvalPrediction, PredictionOutput, set_seed, EvaluationStrategy
...
class LMTFTrainer:
    ...
    def __init__(
        ...
        total_train_batch_size: Optional[int] = 8,
        ...
        self.total_train_batch_size = total_train_batch_size
        self.args = args
    ...
    def get_train_tfdataset(self) -> tf.data.Dataset:
        ...
        logger.warning(f"get_train_tfdataset self.args.strategy: {self.args.strategy}")
            ...
            for epoch_iter in train_iterator:
                ...
                for step, batch in enumerate(epoch_iterator):
                    ...
                    try:
                        ...
                        loss_update = 'Train Epoch ' + str(epochs_trained) + " (Calculating)"
